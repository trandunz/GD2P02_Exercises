...
int main()
{
	...
	line.Point1.x = GrabNumberInput() - ASCIIOFFSET;
	std::cout << (char)(line.Point1.x + ASCIIOFFSET) << ",";
	line.Point1.y = GrabNumberInput() - ASCIIOFFSET;
	std::cout << (char)(line.Point1.y + ASCIIOFFSET) << ",";
	line.Point1.z = GrabNumberInput() - ASCIIOFFSET;
	std::cout << (char)(line.Point1.z + ASCIIOFFSET) << ")" << std::endl;

	std::cout << "Second Point On Line (x,y,z): (";
	line.Point2.x = GrabNumberInput() - ASCIIOFFSET;
	std::cout << (char)(line.Point2.x + ASCIIOFFSET) << ",";
	line.Point2.y = GrabNumberInput() - ASCIIOFFSET;
	std::cout << (char)(line.Point2.y + ASCIIOFFSET) << ",";
	line.Point2.z = GrabNumberInput() - ASCIIOFFSET;
